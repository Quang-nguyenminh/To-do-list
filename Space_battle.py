...
def yellow_control(keys_pressed, yellow):
    if keys_pressed[pygame.K_a] and yellow.x - VEL > -20:
        yellow.x -= VEL
    if keys_pressed[pygame.K_d] and yellow.x + VEL < 860:
        yellow.x += VEL
    if keys_pressed[pygame.K_w] and yellow.y - VEL > -15:
        yellow.y -= VEL
    if keys_pressed[pygame.K_s] and yellow.y + VEL < 435:
        yellow.y += VEL


def red_control(keys_pressed, red):
    if keys_pressed[pygame.K_LEFT] and red.x - VEL > -20:
        red.x -= VEL
    if keys_pressed[pygame.K_RIGHT] and red.x + VEL < 860:
        red.x += VEL
    if keys_pressed[pygame.K_UP] and red.y - VEL > -15:
        red.y -= VEL
    if keys_pressed[pygame.K_DOWN] and red.y + VEL < 435:
        red.y += VEL
